...
function getTestBattleInfo()
    ...
    for i=1,6 do
        ...
        heroInfo.currRage = 0
        heroInfo.htid = 20002
        heroInfo.hid = 3010020+i
        
        team1arrHero[i] = heroInfo
    end
    team1arrHero[6].hid = 3012621
    ...
    for i=1,6 do
        ...
        heroInfo.currRage = 0
        heroInfo.htid = 20002
        heroInfo.hid = 3010040+i
        
        team2arrHero[i] = heroInfo
    end
    team2arrHero[6].hid = 3012631
    ...
    --battle1
    local battle1 = {}
    battle1.defender = 3010041
    battle1.arrReaction = {}
    battle1.arrReaction[1] = {}
    battle1.arrReaction[1].defender = 3010041
    ...
    --battle3
    local battle3 = {}
    battle3.defender = 3010023
    battle3.arrReaction = {}
    battle3.arrReaction[1] = {}
    battle3.arrReaction[1].defender = 3010023
    ...
    battle3.arrReaction[2].defender = 3012631
    ...
    --battle4
    local battle4 = {}
    battle4.defender = 3010041
    battle4.arrReaction = {}
    battle4.arrReaction[1] = {}
    battle4.arrReaction[1].defender = 3010041
    ...
    battle4.arrReaction[2].defender = 3010044
    ...
    --battle5
    local battle5 = {}
    battle5.defender = 3010041
    battle5.arrReaction = {}
    battle5.arrReaction[1] = {}
    battle5.arrReaction[1].defender = 3010041
    ...
    --battle6
    local battle6 = {}
    battle6.defender = 3010041
    battle6.arrReaction = {}
    battle6.arrReaction[1] = {}
    battle6.arrReaction[1].defender = 3010041
    ...
    battle6.arrReaction[2].defender = 3010042
    ...
    battle6.arrReaction[3].defender = 3010043
    ...
    battle6.arrReaction[4].defender = 3010044
    ...
    battle6.arrReaction[5].defender = 3010045
    ...
    battle6.arrReaction[6].defender = 3012631
    ...
    --battle7
    local battle7 = {}
    battle7.defender = 3010041
    battle7.arrReaction = {}
    battle7.arrReaction[1] = {}
    battle7.arrReaction[1].defender = 3010041
    ...
    battle7.arrReaction[2].defender = 3010042
    ...
    battle7.arrReaction[3].defender = 3010043
    ...
    battle7.arrReaction[4].defender = 3010044
    ...
    battle7.arrReaction[5].defender = 3010045
    ...
    battle7.arrReaction[6].defender = 3012631
    ...
    --battle2
    local battle2 = {}
    battle2.defender = 3010021
    battle2.arrReaction = {}
    battle2.arrReaction[1] = {}
    battle2.arrReaction[1].defender = 3010021
    ...
    --battle8
    local battle8 = {}
    battle8.defender = 3010042
    battle8.arrReaction = {}
    battle8.arrReaction[1] = {}
    battle8.arrReaction[1].defender = 3010042
    ...
    --battle9
    local battle9 = {}
    battle9.defender = 3010043
    battle9.arrReaction = {}
    battle9.arrReaction[1] = {}
    battle9.arrReaction[1].defender = 3010043
    ...
    --battle10
    local battle10 = {}
    battle10.defender = 3010023
    battle10.arrReaction = {}
    battle10.arrReaction[1] = {}
    battle10.arrReaction[1].defender = 3010023
    ...
    --battle11
    local battle11 = {}
    battle11.defender = 3010041
    battle11.arrReaction = {}
    battle11.arrReaction[1] = {}
    battle11.arrReaction[1].defender = 3010041
