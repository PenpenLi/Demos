...
local function createLabelWord( tbAnnounce , lsvSize)
	...
	local image = m_content_bg:clone()
...
function create(...)
	...
	m_content_bg = m_fnGetWidget(m_UIMain, "IMG_CONTENT_BG")
	m_content_bg:setSizeType(SIZE_ABSOLUTE)
	m_content_bg:removeFromParent()
	m_content_bg:retain()
