...
CHOOSELIST = {
    ...
    LOADSPECIAL = "images/common/renascence_choose_treasure.png"
}
...
function ChooseList:refresh( ... )
    self.objView:refresh()
end

function ChooseList:changeDataSource( data )
    self.objView:changeDataSource(data)
end