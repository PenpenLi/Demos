...
local function showSelf( allHtid, fnCallback )
	...
	local tbHeroes = {} -- zhangqi, 2015-09-08, 去掉分类，统一显示所有头像
	...
	-- 2015-03-05, 对头像排序，第一优先级：按照资质排序，资质高的排在前面；第二优先级：按照id排序，id大的排在前面
		table.sort(tbHeroes, function ( hero1, hero2 )
	...
	local tbData = {heroes = tbHeroes, callback = fnCallback , curHeroHid = uHtid}
