...
-- args: tbFull, 表示全集的table; tbChild, 求补集的table; 
-- return: 表示补集的table
table.complement = function (tbFull, tbChild)
    local tbRet = {}
...
-- zhangqi, 2015-12-08, 补漏加入后端推送脚本回调 pushGmRunScriptCallback 中用到的方法
...
function isFunc( var )
    return (var and type(var) == "function")
end
