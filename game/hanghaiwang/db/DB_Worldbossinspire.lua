...
keys = {
	"id", "inspireArr", "maxLv", "inspireCd", "inspireSilver", "inspireGold", "rebirthBaseGold", "rebirthGrowGold", "cd", 
}

Worldbossinspire = {
	id_1 = {1, "78|500", 20, 30, 1000, 10, 10, 10, 45, },
}
...
function getDataById(key_id)
	...
	assert(id_data, "Worldbossinspire not found " ..  key_id)
	if id_data == nil then
		return nil
	end
