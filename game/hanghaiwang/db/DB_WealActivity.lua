...
WealActivity = {
	id_1 = {1, "摇摆摇钱树！", nil, "每日摇钱树副本次数2倍", "摇钱树似乎感受到了节日的来临，开始了它最拿手的摇摆舞！\n看着这么得瑟的摇钱树，军师决定发动一场全民摇钱树摇摆活动！\n少年们，快拿起手中的刀枪剑戟指向我们的摇钱树吧！", 0, "300001|2", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, },
	id_2 = {2, "来自星星的宝物！", nil, "每日经验宝物副本次数2倍", "天降奇观！观星台观测到有大量经验宝物坐着天外飞星来到了我们的三国世界！\n快看，这些经验宝物正坐在星星上向大家招着手呢！\n少年们，快追逐星星的轨迹，与宝物们一决胜负吧！", 1, "300002|2", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, },
...
function getDataById(key_id)
	...
	assert(id_data, "WealActivity not found " ..  key_id)
	if id_data == nil then
		return nil
	end
