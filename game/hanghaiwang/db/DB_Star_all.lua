...
keys = {
	"id", "attrRate", "giftGold", "giftincrease", "Likeability", "giftGoldmax", "giftRatio1", "giftRatio2", 
}

Star_all = {
	id_1 = {1, "0|1,0|5,0|9999", 5, 5, 500, 100, 5000, 5000, },
}
...
function getDataById(key_id)
	...
	assert(id_data, "Star_all not found " ..  key_id)
	if id_data == nil then
		return nil
	end
