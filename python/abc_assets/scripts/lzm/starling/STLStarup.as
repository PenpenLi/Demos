package lzm.starling
{
   ...
   public class STLStarup extends Sprite
   {
      ...
      protected function initStarlingWithWH(param1:Class, param2:int, param3:int, param4:int = 480, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false, param8:String = "auto") : void
      {
         ...
         STLConstant.scale = viewPort.width > HDWidth?2:1.0;
         ...
         {
            var /*UnknownSlot*/:* = §§dup(function(param1:Object, param2:STLRootClass):void
            {
         ...
         LogUtil("handleLostContext:" + Starling.handleLostContext);
         LogUtil("Scale:" + STLConstant.scale);
         LogUtil("StageWidth:" + STLConstant.StageWidth);
         LogUtil("StageHeight:" + STLConstant.StageHeight);
      }
