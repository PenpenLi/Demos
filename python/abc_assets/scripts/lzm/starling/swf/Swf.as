package lzm.starling.swf
{
   ...
   public class Swf
   {
      ...
      private var _swfUpdateManager:lzm.starling.swf.SwfUpdateManager;
      ...
      public function Swf(param1:ByteArray, param2:AssetManager, param3:int = 24)
      {
         ...
         this._assets = param2;
         this._swfUpdateManager = new lzm.starling.swf.SwfUpdateManager(param3,starlingRoot);
      ...
      public function get swfUpdateManager() : lzm.starling.swf.SwfUpdateManager
      {
      ...
      public function createSprite(param1:String, param2:Array = null, param3:Array = null) : SwfSprite
      {
         ...
         if(param3 == null)
         {
            var param3:Array = _swfDatas["spr"][param1];
         }
         ...
         while(_loc9_ < _loc4_)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc6_ is DisplayObject)
               {
                  ...
                  _loc6_.skewX = _loc8_[6] * 0.017453292519943295;
                  _loc6_.skewY = _loc8_[7] * 0.017453292519943295;
