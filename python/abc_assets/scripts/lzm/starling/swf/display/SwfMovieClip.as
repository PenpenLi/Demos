   ...
   public class SwfMovieClip extends SwfSprite implements ISwfAnimation
   {
      ...
      public function set currentFrame(param1:int) : void
      {
         ...
         while(_loc6_ < _loc3_)
         {
            ...
            _loc5_.mSkewX = _loc4_[6] * 0.017453292519943295;
            _loc5_.mSkewY = _loc4_[7] * 0.017453292519943295;
            _loc5_.alpha = _loc4_[8];
            _loc5_.mName = _loc4_[9];
            if(_loc4_[1] == "particle")
            {
               §§dup(_loc5_)["setPostion"](_loc4_[2],_loc4_[3]);
            }
            else
            {
               _loc5_.mX = _loc4_[2];
            ...
            if("s9" !== _loc7_)
            {
               ...
               {
                  §§dup(_loc5_)["setSize"](_loc4_[11],_loc4_[12]);
      ...
      private function goTo(param1:*) : void
      {
         ...
         if(param1 is String)
         {
            ...
            _startFrame = §§dup(_loc2_[1]);
            _currentFrame = _loc2_[1];
            _endFrame = _loc2_[2];
         }
         else if(param1 is int)
         {
            _startFrame = §§dup(param1);
            _currentFrame = param1;
            _endFrame = _frames.length - 1;
         }
         currentFrame = _currentFrame;
      ...
      override public function dispose() : void
      {
         var _loc1_:* = 0;
         var _loc2_:* = 0;
         if(_ownerSwf != null && _ownerSwf.swfUpdateManager != null)
         {
            _ownerSwf.swfUpdateManager.removeSwfAnimation(this);
            _ownerSwf = null;
         }
