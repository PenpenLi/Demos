   ...
   public class List extends Scroller implements IFocusDisplayObject
   {
      ...
      public function set selectedItems(param1:Vector.<Object>) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            _loc2_ = this._dataProvider.getItemIndex(_loc3_);
            if(_loc2_ >= 0)
            {
               _loc4_.push(_loc2_);
            }
      ...
      public function getSelectedItems(param1:Vector.<Object> = null) : Vector.<Object>
      {
         ...
         {
            var param1:Vector.<Object> = new Vector.<Object>(0);
         }
         if(!this._dataProvider)
         {
            return param1;
         ...
         while(_loc5_ < _loc3_)
         {
            _loc2_ = this._selectedIndices.getItemAt(_loc5_) as int;
      ...
      override protected function handlePendingScroll() : void
      {
         ...
         {
            _loc3_ = this._dataProvider.getItemAt(this.pendingItemIndex);
            if(_loc3_ is Object)
            {
