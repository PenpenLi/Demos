   ...
   public class TiledRowsLayout extends EventDispatcher implements IVirtualLayout
   {
      ...
      public function layout(param1:Vector.<DisplayObject>, param2:ViewPortBounds = null, param3:LayoutBoundsResult = null) : LayoutBoundsResult
      {
         ...
         while(_loc35_ < _loc43_)
         {
            ...
            if(!(_loc39_ is ILayoutDisplayObject && !ILayoutDisplayObject(_loc39_).includeInLayout))
            {
               ...
               if(_loc36_ == _loc42_)
               {
                  ...
                  {
                     _loc29_ = §§dup(_loc17_ + _loc38_ * _loc34_);
         ...
         if(this._paging != "none")
         {
            ...
            _loc16_ = this._useVirtualLayout?_loc20_.length - 1:_loc35_ - 1;
            this.applyHorizontalAlign(_loc20_,_loc15_,_loc16_,_loc25_,_loc26_);
            this.applyVerticalAlign(_loc20_,_loc15_,_loc16_,_loc10_,_loc27_);
            if(this.manageVisibility)
            {
         ...
         var _loc14_:* = _loc25_;
         if(!isNaN(_loc38_) && this._paging == "horizontal")
         {
            _loc14_ = Math.ceil(_loc43_ / _loc31_) * _loc38_;
         }
         var _loc13_:Number = _loc5_ + _loc9_ + this._paddingBottom;
         if(!isNaN(_loc24_))
         {
            if(this._paging == "horizontal")
            {
      ...
      public function measureViewPort(param1:int, param2:ViewPortBounds = null, param3:Point = null) : Point
      {
         ...
         var _loc26_:Boolean = isNaN(_loc8_);
         var _loc17_:Boolean = isNaN(_loc19_);
         if(!_loc26_ && !_loc17_)
         {
            param3.x = _loc8_;
            param3.y = _loc19_;
         ...
         var _loc30_:Number = param2?param2.x:0.0;
         var _loc35_:Number = param2?param2.y:0.0;
         var _loc4_:Number = param2?param2.minWidth:0.0;
         var _loc27_:Number = param2?param2.minHeight:0.0;
         var _loc15_:Number = param2?param2.maxWidth:Infinity;
         var _loc29_:Number = param2?param2.maxHeight:Infinity;
         this.prepareTypicalItem();
         var _loc34_:Number = this._typicalItem?this._typicalItem.width:0.0;
         ...
         {
            _loc28_ = _loc8_;
            _loc6_ = (_loc8_ - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc22_ + this._horizontalGap);
         }
         else if(!isNaN(_loc15_))
         {
            _loc28_ = _loc15_;
            _loc6_ = (_loc15_ - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc22_ + this._horizontalGap);
         }
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         ...
         {
            _loc16_ = _loc19_;
            _loc21_ = (_loc19_ - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc7_ + this._verticalGap);
         }
         else if(!isNaN(_loc29_))
         {
            _loc16_ = _loc29_;
            _loc21_ = (_loc29_ - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc7_ + this._verticalGap);
         }
         if(_loc21_ < 1)
         {
            _loc21_ = 1;
         }
         var _loc18_:Number = _loc6_ * (_loc22_ + this._horizontalGap) - this._horizontalGap + this._paddingLeft + this._paddingRight;
         var _loc11_:Number = _loc30_ + this._paddingLeft;
         var _loc12_:Number = _loc35_ + this._paddingTop;
         var _loc23_:int = _loc6_ * _loc21_;
         var _loc25_:* = 0;
         var _loc31_:* = _loc23_;
         var _loc20_:* = _loc11_;
         var _loc13_:* = _loc11_;
         ...
         {
            if(_loc24_ != 0 && _loc24_ % _loc6_ == 0)
            {
               _loc13_ = _loc20_;
               _loc5_ = _loc5_ + (_loc7_ + this._verticalGap);
            }
            if(_loc24_ == _loc31_)
            {
               _loc25_++;
               _loc31_ = _loc31_ + _loc23_;
               if(this._paging == "horizontal")
               {
                  _loc20_ = §§dup(_loc11_ + _loc28_ * _loc25_);
                  _loc13_ = _loc11_ + _loc28_ * _loc25_;
                  _loc5_ = _loc12_;
               }
               else if(this._paging == "vertical")
               {
                  _loc5_ = _loc12_ + _loc16_ * _loc25_;
               }
            }
            _loc24_++;
         }
         var _loc10_:* = _loc18_;
         if(!isNaN(_loc28_) && this._paging == "horizontal")
         {
            _loc10_ = Math.ceil(param1 / _loc23_) * _loc28_;
         }
         var _loc9_:Number = _loc5_ + _loc7_ + this._paddingBottom;
         if(!isNaN(_loc16_))
         {
            if(this._paging == "horizontal")
            {
            ...
            {
               _loc9_ = Math.ceil(param1 / _loc23_) * _loc16_;
            }
         }
         if(_loc26_)
         {
      ...
      public function getScrollPositionForIndex(param1:int, param2:Vector.<DisplayObject>, param3:Number, param4:Number, param5:Number, param6:Number, param7:Point = null) : Point
      {
         ...
         var _loc9_:int = (param5 - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc12_ + this._horizontalGap);
         if(_loc9_ < 1)
         {
            _loc9_ = 1;
         }
         if(this._paging != "none")
         {
            _loc8_ = (param6 - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc13_ + this._verticalGap);
            if(_loc8_ < 1)
            {
               _loc8_ = 1;
            }
         ...
         {
            param7.x = 0;
            param7.y = this._paddingTop + (_loc13_ + this._verticalGap) * param1 / _loc9_ + (param6 - _loc13_) / 2;
         }
         return param7;
      }
      ...
      protected function getVisibleIndicesAtScrollPositionWithHorizontalPaging(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:Vector.<int>) : void
      {
         ...
         var _loc16_:Number = this._typicalItem?this._typicalItem.height:0.0;
         var _loc23_:* = _loc28_;
         var _loc11_:* = _loc16_;
         if(_loc23_ < 0)
         {
         ...
         var _loc19_:int = (param4 - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc11_ + this._verticalGap);
         if(_loc19_ < 1)
         {
            _loc19_ = 1;
         }
         var _loc22_:int = _loc9_ * _loc19_;
         var _loc24_:int = _loc22_ + 2 * _loc19_;
         if(_loc24_ > param5)
         {
            _loc24_ = param5;
         }
         ...
         var _loc10_:Number = _loc9_ * (_loc23_ + this._horizontalGap) - this._horizontalGap;
         var _loc17_:* = 0.0;
         var _loc14_:* = 0.0;
         if(_loc10_ < param3)
         {
            if(this._horizontalAlign == "right")
            {
               _loc17_ = param3 - this._paddingLeft - this._paddingRight - _loc10_;
               _loc14_ = 0.0;
            }
            else if(this._horizontalAlign == "center")
            {
               _loc14_ = §§dup((param3 - this._paddingLeft - this._paddingRight - _loc10_) / 2);
               _loc17_ = (param3 - this._paddingLeft - this._paddingRight - _loc10_) / 2;
            }
            else if(this._horizontalAlign == "left")
            {
               _loc17_ = 0.0;
         ...
         var _loc18_:Number = param1 - _loc13_;
         if(_loc18_ < 0)
         {
            _loc18_ = -_loc18_ - this._paddingRight - _loc14_;
            if(_loc18_ < 0)
            {
               _loc18_ = 0.0;
            }
            _loc12_ = -Math.floor(_loc18_ / (_loc23_ + this._horizontalGap)) - 1;
            _loc7_ = _loc7_ + (-_loc22_ + _loc9_ + _loc12_);
         }
         else if(_loc18_ > 0)
         {
            _loc18_ = _loc18_ - this._paddingLeft - _loc17_;
            if(_loc18_ < 0)
            {
               _loc18_ = 0.0;
            }
            _loc12_ = Math.floor(_loc18_ / (_loc23_ + this._horizontalGap));
         ...
         {
            _loc26_ = 0;
            _loc27_ = (_loc9_ + _loc12_) % _loc9_;
            _loc20_ = _loc7_ / _loc22_ * _loc22_;
            _loc25_ = _loc7_;
            _loc15_ = 0;
            do
            {
               ...
               if(_loc26_ == _loc19_)
               {
                  ...
                  _loc25_ = _loc20_ + _loc27_ - _loc9_;
               }
               _loc25_ = _loc25_ + _loc9_;
            }
            while(_loc15_ < _loc24_ && _loc20_ < param5);
      ...
      protected function getVisibleIndicesAtScrollPositionWithVerticalPaging(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:Vector.<int>) : void
      {
         ...
         var _loc16_:int = (param4 - this._paddingTop - this._paddingBottom + this._verticalGap) / (_loc10_ + this._verticalGap);
         if(_loc16_ < 1)
         {
            _loc16_ = 1;
         }
         var _loc20_:int = _loc9_ * _loc16_;
         var _loc22_:int = _loc20_ + 2 * _loc9_;
         if(_loc22_ > param5)
         {
            _loc22_ = param5;
         }
         ...
         var _loc12_:Number = _loc16_ * (_loc10_ + this._verticalGap) - this._verticalGap;
         var _loc18_:* = 0.0;
         var _loc17_:* = 0.0;
         if(_loc12_ < param4)
         {
            if(this._verticalAlign == "bottom")
            {
               _loc18_ = param4 - this._paddingTop - this._paddingBottom - _loc12_;
               _loc17_ = 0.0;
            }
            else if(this._verticalAlign == "middle")
            {
               _loc17_ = §§dup((param4 - this._paddingTop - this._paddingBottom - _loc12_) / 2);
               _loc18_ = (param4 - this._paddingTop - this._paddingBottom - _loc12_) / 2;
            }
            else if(this._verticalAlign == "top")
            {
               _loc18_ = 0.0;
               _loc17_ = param4 - this._paddingTop - this._paddingBottom - _loc12_;
            }
         }
         var _loc11_:* = 0;
         ...
         if(_loc15_ < 0)
         {
            _loc15_ = -_loc15_ - this._paddingBottom - _loc17_;
            if(_loc15_ < 0)
            {
               _loc15_ = 0.0;
            }
            _loc11_ = -Math.floor(_loc15_ / (_loc10_ + this._verticalGap)) - 1;
            _loc7_ = _loc7_ + _loc9_ * _loc11_;
         }
         else if(_loc15_ > 0)
         {
            _loc15_ = _loc15_ - this._paddingTop - _loc18_;
            if(_loc15_ < 0)
            {
               _loc15_ = 0.0;
            }
            _loc11_ = Math.floor(_loc15_ / (_loc10_ + this._verticalGap));
            _loc7_ = _loc7_ + _loc9_ * _loc11_;
         }
         if(_loc7_ < 0)
         {
      ...
      protected function getVisibleIndicesAtScrollPositionWithoutPaging(param1:Number, param2:Number, param3:Number, param4:Number, param5:int, param6:Vector.<int>) : void
      {
         ...
         var _loc11_:int = (param3 - this._paddingLeft - this._paddingRight + this._horizontalGap) / (_loc12_ + this._horizontalGap);
         if(_loc11_ < 1)
         {
            _loc11_ = 1;
         }
         var _loc8_:int = Math.ceil((param4 - this._paddingTop + this._verticalGap) / (_loc13_ + this._verticalGap)) + 1;
         var _loc14_:int = _loc8_ * _loc11_;
         if(_loc14_ > param5)
         {
            _loc14_ = param5;
         }
         var _loc7_:* = 0;
         var _loc19_:Number = Math.ceil(param5 / _loc11_) * (_loc13_ + this._verticalGap) - this._verticalGap;
         if(_loc19_ < param4)
         {
            if(this._verticalAlign == "bottom")
            {
               _loc7_ = Math.ceil((param4 - _loc19_) / (_loc13_ + this._verticalGap));
            }
            else if(this._verticalAlign == "middle")
            {
               _loc7_ = Math.ceil((param4 - _loc19_) / (_loc13_ + this._verticalGap) / 2);
            }
         }
         var _loc17_:int = -_loc7_ + Math.floor((param2 - this._paddingTop + this._verticalGap) / (_loc13_ + this._verticalGap));
         var _loc9_:int = _loc17_ * _loc11_;
         if(_loc9_ < 0)
         {
            _loc9_ = 0;
         }
         var _loc16_:int = _loc9_ + _loc14_;
         if(_loc16_ > param5)
         {
            _loc16_ = param5;
         }
         _loc9_ = _loc16_ - _loc14_;
