package feathers.skins
{
   ...
   public class SmartDisplayObjectStateValueSelector extends StateWithToggleValueSelector
   {
      ...
      {
         var _loc3_:Image = param2 as Image;
         if(_loc3_)
         {
      ...
      {
         var _loc3_:Scale3Image = param2 as Scale3Image;
         if(_loc3_)
         {
      ...
      {
         var _loc3_:Scale9Image = param2 as Scale9Image;
         if(_loc3_)
         {
            _loc3_.textures = param1;
            _loc3_.readjustSize();
      ...
      {
         var _loc3_:Quad = param2 as Quad;
         if(!_loc3_)
         {
            _loc3_ = new Quad(100,100,param1);
         }
         _loc3_.color = param1;
         return _loc3_;
      }
      ...
      {
         var _loc4_:Class = Class(param1.constructor);
      ...
      public function getValueTypeHandler(param1:Class, param2:Function) : Function
      {
