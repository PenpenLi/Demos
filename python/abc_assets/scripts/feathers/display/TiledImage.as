   ...
   public class TiledImage extends Sprite implements IValidating
   {
      ...
      public function validate() : void
      {
         ...
         if(this._propertiesChanged || this._layoutChanged)
         {
            ...
            _loc3_ = this._originalImageWidth * this._textureScale;
            _loc10_ = this._originalImageHeight * this._textureScale;
            _loc12_ = Math.ceil(this._width / _loc3_);
            _loc5_ = Math.ceil(this._height / _loc10_);
            _loc4_ = _loc12_ * _loc5_;
            _loc11_ = 0.0;
            _loc8_ = 0.0;
            _loc14_ = _loc11_ + _loc3_;
            _loc7_ = _loc8_ + _loc10_;
            _loc9_ = 0;
            while(_loc9_ < _loc4_)
            {
               this._image.x = _loc11_;
               this._image.y = _loc8_;
               _loc13_ = _loc14_ >= this._width?this._width - _loc11_:_loc3_;
               _loc1_ = _loc7_ >= this._height?this._height - _loc8_:_loc10_;
               this._image.width = _loc13_;
               this._image.height = _loc1_;
               _loc2_ = _loc13_ / _loc3_;
               _loc6_ = _loc1_ / _loc10_;
               HELPER_POINT.x = _loc2_;
               HELPER_POINT.y = 0;
