package feathers.core
{
   ...
   public final class ValidationQueue implements IAnimatable
   {
      ...
      private var _delayedQueue:Vector.<feathers.core.IValidating>;
      
      private var _queue:Vector.<feathers.core.IValidating>;
      
      public function ValidationQueue(param1:Starling)
      {
         _delayedQueue = new Vector.<feathers.core.IValidating>(0);
         _queue = new Vector.<feathers.core.IValidating>(0);
         super();
      ...
      public static function forStarling(param1:Starling) : ValidationQueue
      {
         ...
         if(!_loc2_)
         {
            _loc2_ = §§dup(new ValidationQueue(param1));
      ...
      public function addControl(param1:feathers.core.IValidating, param2:Boolean) : void
      {
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         var _loc6_:* = null;
         ...
         var _loc5_:Vector.<feathers.core.IValidating> = this._isValidating && param2?this._delayedQueue:this._queue;
         ...
         if(this._isValidating && _loc5_ == this._queue)
         {
            ...
            while(_loc8_ >= 0)
            {
               _loc6_ = feathers.core.IValidating(_loc5_[_loc8_]);
               _loc3_ = _loc6_.depth;
               if(_loc7_ < _loc3_)
               {
                  _loc8_--;
      ...
      public function advanceTime(param1:Number) : void
      {
         ...
         var _loc4_:Vector.<feathers.core.IValidating> = this._queue;
         this._queue = this._delayedQueue;
         this._delayedQueue = _loc4_;
         this._isValidating = false;
      }
      
      protected function queueSortFunction(param1:feathers.core.IValidating, param2:feathers.core.IValidating) : int
      {
