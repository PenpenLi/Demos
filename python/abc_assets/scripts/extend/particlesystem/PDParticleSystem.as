package extend.particlesystem
{
   ...
   public class PDParticleSystem extends ParticleSystem
   {
      ...
      private var mStartColor:extend.particlesystem.ColorArgb;
      
      private var mStartColorVariance:extend.particlesystem.ColorArgb;
      
      private var mEndColor:extend.particlesystem.ColorArgb;
      
      private var mEndColorVariance:extend.particlesystem.ColorArgb;
      ...
      override protected function initParticle(param1:Particle) : void
      {
         ...
         var _loc12_:extend.particlesystem.ColorArgb = _loc8_.colorArgb;
         var _loc5_:extend.particlesystem.ColorArgb = _loc8_.colorArgbDelta;
      ...
      override protected function advanceParticle(param1:Particle, param2:Number) : void
      {
         ...
         var param2:Number = _loc8_ > param2?param2:_loc8_;
         ...
         else
         {
            ...
            _loc6_ = _loc12_;
            _loc12_ = -_loc9_ * _loc3_.tangentialAcceleration;
            _loc9_ = _loc6_ * _loc3_.tangentialAcceleration;
      ...
      private function parseConfig(param1:XML) : void
      {
         ...
         mDuration = getFloatValue(config.duration);
         mDuration = mDuration == -1?1.7976931348623157E308:mDuration;
      }
      ...
      public function get startColor() : extend.particlesystem.ColorArgb
      {
         return mStartColor;
      }
      
      public function set startColor(param1:extend.particlesystem.ColorArgb) : void
      {
         mStartColor = param1;
      }
      
      public function get startColorVariance() : extend.particlesystem.ColorArgb
      {
         return mStartColorVariance;
      }
      
      public function set startColorVariance(param1:extend.particlesystem.ColorArgb) : void
      {
         mStartColorVariance = param1;
      }
      
      public function get endColor() : extend.particlesystem.ColorArgb
      {
         return mEndColor;
      }
      
      public function set endColor(param1:extend.particlesystem.ColorArgb) : void
      {
         mEndColor = param1;
      }
      
      public function get endColorVariance() : extend.particlesystem.ColorArgb
      {
         return mEndColorVariance;
      }
      
      public function set endColorVariance(param1:extend.particlesystem.ColorArgb) : void
      {
      ...
      public function startPD(param1:Function = null, param2:int = 100) : void
      {
         ...
         if(mDuration == -1 || mDuration == 1.7976931348623157E308)
         {
            return;
         }
         if(callBack != null)
