package crypto.certs.hurlant.crypto.symmetric
{
   ...
   import crypto.certs.hurlant.crypto.prng.Random;
   ...
   public class AESKey implements ISymmetricKey
   {
      ...
      private function expandKey() : void
      {
         ...
         var _loc7_:* = 0;
         var _loc4_:* = 0;
         var _loc6_:uint = key.length / 4;
         Nr = _loc6_ + 6;
         _loc4_ = _loc6_;
         while(_loc4_ < 4 * (Nr + 1))
         {
            _loc7_ = key[4 * _loc4_ - 4];
            _loc3_ = key[4 * _loc4_ - 3];
            _loc5_ = key[4 * _loc4_ - 2];
            _loc1_ = key[4 * _loc4_ - 1];
            if(!(_loc4_ % _loc6_))
            {
               _loc2_ = _loc1_;
               _loc1_ = Sbox[_loc7_];
               _loc7_ = Sbox[_loc3_] ^ Rcon[_loc4_ / _loc6_];
               _loc3_ = Sbox[_loc5_];
               _loc5_ = Sbox[_loc2_];
            }
            ...
            key[4 * _loc4_ + 0] = key[4 * _loc4_ - 4 * _loc6_ + 0] ^ _loc7_;
            key[4 * _loc4_ + 1] = key[4 * _loc4_ - 4 * _loc6_ + 1] ^ _loc3_;
            key[4 * _loc4_ + 2] = key[4 * _loc4_ - 4 * _loc6_ + 2] ^ _loc5_;
            key[4 * _loc4_ + 3] = key[4 * _loc4_ - 4 * _loc6_ + 3] ^ _loc1_;
            _loc4_++;
         }
      }
      ...
      protected function addRoundKey(param1:ByteArray, param2:uint) : void
      {
         ...
         {
            var _loc4_:* = _loc3_;
            var _loc5_:* = state[_loc4_] ^ param1[_loc3_ + param2];
            state[_loc4_] = _loc5_;
            _loc3_++;
         }
      }
