package starling.display.graphics
{
   public class RoundedRectangle extends Graphic
   {
      ...
      {
         var param1:Number = param1 < 0?0:param1;
         _bottomRightRadius = §§dup(param1);
         _bottomLeftRadius = §§dup(param1);
         _topRightRadius = §§dup(param1);
      ...
      override protected function buildGeometry() : void
      {
         ...
         if(_loc3_ > 0)
         {
            ...
            while(_loc6_ < _loc9_)
            {
               _loc1_ = (_loc6_ + 1) / (_loc9_ + 1) * 3.141592653589793 * 0.5;
               _loc1_ = _loc1_ + 3.141592653589793 * 1.5;
         ...
         if(_loc4_ > 0)
         {
            ...
            {
               _loc1_ = (_loc6_ + 1) / (_loc9_ + 1) * 3.141592653589793 * 0.5;
               _loc1_ = _loc1_ + 3.141592653589793 * 0.5;
               _loc10_ = Math.sin(_loc1_);
               _loc2_ = Math.cos(_loc1_);
         ...
         if(_loc8_ > 0)
         {
            ...
            {
               _loc1_ = (_loc6_ + 1) / (_loc9_ + 1) * 3.141592653589793 * 0.5;
               _loc1_ = _loc1_ + 3.141592653589793;
               _loc10_ = Math.sin(_loc1_);
               _loc2_ = Math.cos(_loc1_);
