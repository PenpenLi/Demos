package starling.display.graphics
{
   ...
   public class Fill extends Graphic
   {
      ...
      protected static function triangulate(param1:starling.display.graphics.VertexList, param2:int, param3:Vector.<Number>, param4:Vector.<uint>, param5:Boolean) : void
      {
         ...
         var _loc10_:* = null;
         var _loc22_:* = false;
         var param1:starling.display.graphics.VertexList = starling.display.graphics.VertexList.clone(param1);
         var _loc14_:Vector.<starling.display.graphics.VertexList> = null;
         if(param5 == false)
         {
         ...
         {
            _loc14_ = new Vector.<starling.display.graphics.VertexList>();
            _loc14_.push(param1);
         }
         ...
         while(_loc14_.length > 0)
         {
            ...
            {
               starling.display.graphics.VertexList.reverse(_loc8_);
            }
            _loc21_ = 0;
            _loc15_ = false;
            _loc20_ = _loc8_.head;
            while(_loc21_ <= param2 * 3)
            {
               ...
               if(_loc9_.next == _loc7_)
               {
                  ...
                  starling.display.graphics.VertexList.releaseNode(_loc7_);
                  starling.display.graphics.VertexList.releaseNode(_loc6_);
                  starling.display.graphics.VertexList.releaseNode(_loc9_);
                  break;
               }
            ...
            starling.display.graphics.VertexList.dispose(_loc8_);
         }
      }
      ...
      protected static function convertToSimple(param1:starling.display.graphics.VertexList) : Vector.<starling.display.graphics.VertexList>
      {
         ...
         var _loc8_:* = null;
         var _loc10_:* = null;
         var _loc12_:Vector.<starling.display.graphics.VertexList> = new Vector.<starling.display.graphics.VertexList>();
         var _loc2_:* = 0;
         var _loc6_:Vector.<starling.display.graphics.VertexList> = new Vector.<starling.display.graphics.VertexList>();
         _loc6_.push(param1);
               ...
               do
               {
                  ...
                  do
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        _loc13_ = false;
                        _loc9_ = _loc7_.next;
                        _loc14_ = starling.display.graphics.VertexList.getNode();
                        ...
                        _loc7_.next = _loc14_;
                        _loc8_ = _loc4_;
                        _loc10_ = starling.display.graphics.VertexList.getNode();
      ...
      protected static function windingNumberAroundPoint(param1:starling.display.graphics.VertexList, param2:Number, param3:Number) : int
      {
         ...
         var _loc10_:* = false;
         var _loc9_:* = 0;
         var _loc5_:starling.display.graphics.VertexList = param1.head;
         do
         {
            ...
            if(param3 > _loc6_ && param3 < _loc7_ || param3 > _loc7_ && param3 < _loc6_)
            {
               ...
               if(_loc10_)
               {
                  _loc9_ = _loc9_ + ((_loc8_ - _loc4_) * (param3 - _loc6_) - (_loc7_ - _loc6_) * (param2 - _loc4_) < 0?1:0.0);
               }
               else
               {
                  _loc9_ = _loc9_ + ((_loc8_ - _loc4_) * (param3 - _loc6_) - (_loc7_ - _loc6_) * (param2 - _loc4_) < 0?0:-1.0);
               }
            }
            _loc5_ = _loc5_.next;
         }
      ...
      public static function isClockWise(param1:starling.display.graphics.VertexList) : Boolean
      {
         ...
         do
         {
            _loc3_ = _loc3_ + (_loc2_.next.vertex[0] - _loc2_.vertex[0]) * (_loc2_.next.vertex[1] + _loc2_.vertex[1]);
            _loc2_ = _loc2_.next;
         }
      ...
      protected static function windingNumber(param1:starling.display.graphics.VertexList) : int
      {
         ...
         do
         {
            _loc3_ = _loc3_ + ((_loc2_.next.vertex[0] - _loc2_.vertex[0]) * (_loc2_.next.next.vertex[1] - _loc2_.vertex[1]) - (_loc2_.next.next.vertex[0] - _loc2_.vertex[0]) * (_loc2_.next.vertex[1] - _loc2_.vertex[1]) < 0?-1:1.0);
            _loc2_ = _loc2_.next;
         }
         while(_loc2_ != param1.head);
      ...
      protected static function intersection(param1:starling.display.graphics.VertexList, param2:starling.display.graphics.VertexList, param3:starling.display.graphics.VertexList, param4:starling.display.graphics.VertexList) : Vector.<Number>
      {
         ...
         if((_loc6_ < 0?-_loc6_:_loc6_) < 1.0E-7)
         {
            return null;
         }
      ...
      public function clear() : void
      {
         ...
         _numVertices = 0;
         starling.display.graphics.VertexList.dispose(fillVertices);
         fillVertices = null;
         setGeometryInvalid();
         _isConvex = true;
      }
      ...
      public function addDegenerates(param1:Number, param2:Number, param3:uint = 16777215, param4:Number = 1) : void
      {
         ...
         _loc5_ = _loc9_[3] * 255 << 16;
         _loc5_ = _loc5_ | _loc9_[4] * 255 << 8;
         _loc5_ = _loc5_ | _loc9_[5] * 255;
      ...
      protected function addVertexInternal(param1:Number, param2:Number, param3:uint = 16777215, param4:Number = 1) : void
      {
         ...
         var _loc6_:starling.display.graphics.VertexList = starling.display.graphics.VertexList.getNode();
         if(_numVertices == 0)
         {
            fillVertices = _loc6_;
            _loc6_.head = _loc6_;
