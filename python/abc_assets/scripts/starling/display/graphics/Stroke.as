package starling.display.graphics
{
   ...
   public class Stroke extends Graphic
   {
      ...
      protected static function createPolyLinePreAlloc(param1:Vector.<starling.display.graphics.StrokeVertex>, param2:Vector.<Number>, param3:Vector.<uint>, param4:Boolean) : void
      {
         var _loc45_:* = NaN;
         _loc45_ = 3.141592653589793;
         var _loc38_:* = false;
         var _loc15_:* = false;
         var _loc43_:* = 0;
         var _loc26_:* = false;
         ...
         while(_loc43_ < _loc18_)
         {
            ...
            if(param4)
            {
               ...
               if(_loc12_ != 0)
               {
                  _loc40_ = _loc12_ == 2?_loc43_ - 1:_loc43_ + 1;
               }
               _loc38_ = _loc40_ == 0 || param1[_loc40_ - 1].degenerate > 0;
               _loc15_ = _loc40_ == _loc18_ - 1 || param1[_loc40_ + 1].degenerate > 0;
            }
            else
            {
               _loc38_ = _loc40_ == 0;
            ...
            _loc16_ = _loc38_?_loc40_:_loc40_ - 1;
            _loc17_ = _loc15_?_loc40_:_loc40_ + 1;
            ...
            _loc10_ = Math.sqrt(_loc14_ * _loc14_ + _loc13_ * _loc13_);
            _loc11_ = Math.sqrt(_loc48_ * _loc48_ + _loc49_ * _loc49_);
            _loc35_ = _loc22_ * 0.5;
            if(_loc26_)
            {
               if(_loc10_ == 0)
               ...
               _loc35_ = _loc35_ / Math.sin((3.141592653589793 - _loc21_) * 0.5);
            ...
            _loc9_ = _loc12_?_loc30_:_loc34_ - _loc39_;
            _loc28_ = _loc12_?_loc29_:_loc33_ - _loc41_;
            _loc27_++;
      ...
      protected static function createPolyLine(param1:Vector.<starling.display.graphics.StrokeVertex>, param2:Vector.<Number>, param3:Vector.<uint>, param4:int) : void
      {
         ...
         while(_loc33_ < _loc32_)
         {
            ...
            if(_loc16_ != 0)
            {
               _loc28_ = _loc16_ == 2?_loc33_ - 1:_loc33_ + 1;
            }
            _loc25_ = _loc28_ == 0 || param1[_loc28_ - 1].degenerate > 0;
            _loc23_ = _loc28_ == _loc32_ - 1 || param1[_loc28_ + 1].degenerate > 0;
            _loc26_ = _loc25_?_loc28_:_loc28_ - 1;
            _loc30_ = _loc23_?_loc28_:_loc28_ + 1;
            ...
            if(!(_loc25_ || _loc23_))
            {
               ...
               _loc19_ = _loc19_ / _loc39_((3.141592653589793 - Math.acos(_loc11_)) * 0.5);
      ...
      protected static function fixUpPolyLine(param1:Vector.<starling.display.graphics.StrokeVertex>) : int
      {
      ...
      public function clear() : void
      {
         ...
         if(_line)
         {
            starling.display.graphics.StrokeVertex.returnInstances(_line);
            _line.length = 0;
         }
         else
         {
            _line = new Vector.<starling.display.graphics.StrokeVertex>();
         }
         _numVertices = 0;
         setGeometryInvalid();
      ...
      public function addDegenerates(param1:Number, param2:Number) : void
      {
         ...
         var _loc3_:starling.display.graphics.StrokeVertex = _line[_numVertices - 1];
      ...
      {
         var _loc4_:starling.display.graphics.StrokeVertex = _line[param1];
         _loc4_.x = param2;
         _loc4_.y = param3;
         if(isInvalid == false)
         {
      ...
      protected function addVertexInternal(param1:Number, param2:Number, param3:Number = 1, param4:uint = 16777215, param5:Number = 1, param6:uint = 16777215, param7:Number = 1) : void
      {
         ...
         var _loc12_:starling.display.graphics.StrokeVertex = starling.display.graphics.StrokeVertex.getInstance();
      ...
      protected function buildGeometryOriginal() : void
      {
         ...
         _loc1_ = _loc1_ + (vertices.length - _loc2_) * 0.1111111111111111;
      }
      ...
      protected function buildGeometryPreAllocatedVectors() : void
      {
         ...
         var _loc4_:* = 0;
         _loc3_ = _loc3_ + (vertices.length - _loc4_) * 0.1111111111111111;
      }
