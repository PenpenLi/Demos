package starling.display
{
   ...
   public class Sprite extends DisplayObjectContainer
   {
      ...
      private var mFlattenedContents:Vector.<starling.display.QuadBatch>;
      ...
      override public function render(param1:RenderSupport, param2:Number) : void
      {
         ...
         if(mFlattenedContents || mFlattenRequested)
         {
            ...
            {
               mFlattenedContents = new Vector.<starling.display.QuadBatch>(0);
            }
            if(mFlattenRequested)
            {
               starling.display.QuadBatch.compile(this,mFlattenedContents);
               param1.applyClipRect();
               mFlattenRequested = false;
            }
            _loc5_ = param2 * this.alpha;
            _loc8_ = mFlattenedContents.length;
            _loc4_ = param1.mvpMatrix;
