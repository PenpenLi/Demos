   ...
   public class QuadBatch extends DisplayObject
   {
      ...
      private static function compileObject(param1:DisplayObject, param2:Vector.<QuadBatch>, param3:int, param4:Matrix, param5:Number = 1.0, param6:String = null, param7:Boolean = false) : int
      {
         ...
         if(param3 == -1)
         {
            ...
            var param3:* = 0;
            _loc17_ = 1.0;
            var param6:String = param1.blendMode;
            var param7:* = true;
            if(param2.length == 0)
            {
      ...
      public function renderCustom(param1:Matrix, param2:Number = 1.0, param3:String = null) : void
      {
         if(mNumQuads == 0)
         {
            return;
      ...
      public function addQuad(param1:Quad, param2:Number = 1.0, param3:Texture = null, param4:String = null, param5:Matrix = null, param6:String = null) : void
      {
         if(param5 == null)
         {
            var param5:Matrix = param1.transformationMatrix;
         }
      ...
      public function addQuadBatch(param1:QuadBatch, param2:Number = 1.0, param3:Matrix = null, param4:String = null) : void
      {
         if(param3 == null)
         {
            var param3:Matrix = param1.transformationMatrix;
         }
         ...
         mSyncRequired = true;
         mNumQuads = §§dup().mNumQuads + _loc7_;
      }
      ...
      public function set capacity(param1:int) : void
      {
         ...
         while(_loc3_ < param1)
         {
            mIndexData[_loc3_ * 6] = _loc3_ * 4;
            mIndexData[_loc3_ * 6 + 1] = _loc3_ * 4 + 1;
            mIndexData[_loc3_ * 6 + 2] = _loc3_ * 4 + 2;
            mIndexData[_loc3_ * 6 + 3] = _loc3_ * 4 + 1;
            mIndexData[_loc3_ * 6 + 4] = _loc3_ * 4 + 3;
            mIndexData[_loc3_ * 6 + 5] = _loc3_ * 4 + 2;
            _loc3_++;
         }
         destroyBuffers();
         mSyncRequired = true;
