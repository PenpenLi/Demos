package starling.display
{
   ...
   public class DisplayObject extends EventDispatcher
   {
      ...
      public var mParent:starling.display.DisplayObjectContainer;
      ...
      public function getBounds(param1:starling.display.DisplayObject, param2:Rectangle = null) : Rectangle
      {
         throw new AbstractMethodError();
      }
      
      public function hitTest(param1:Point, param2:Boolean = false) : starling.display.DisplayObject
      {
      ...
      function setParent(param1:starling.display.DisplayObjectContainer) : void
      {
      ...
      {
         var param1:Number = param1 % 6.283185307179586;
         if(param1 < -3.141592653589793)
         {
            param1 = param1 + 6.283185307179586;
         }
         if(param1 > 3.141592653589793)
         {
            param1 = param1 - 6.283185307179586;
      ...
      public function set transformationMatrix(param1:Matrix) : void
      {
         ...
         mScaleY = mSkewX > -0.7853981633974483 && mSkewX < 0.7853981633974483?param1.d / Math.cos(mSkewX):-param1.c / Math.sin(mSkewX);
         mScaleX = mSkewY > -0.7853981633974483 && mSkewY < 0.7853981633974483?param1.a / Math.cos(mSkewY):param1.b / Math.sin(mSkewY);
      ...
      {
         var param1:Number = normalizeAngle(param1);
         if(mSkewX != param1)
         {
            mSkewX = param1;
            mOrientationChanged = true;
