package starling.animation
{
   ...
   public class Tween extends EventDispatcher implements IAnimatable
   {
      ...
      private var mNextTween:starling.animation.Tween;
      ...
      static function fromPool(param1:Object, param2:Number, param3:Object = "linear") : starling.animation.Tween
      {
      ...
      static function toPool(param1:starling.animation.Tween) : void
      {
         var _loc2_:* = null;
      ...
      public function reset(param1:Object, param2:Number, param3:Object = "linear") : starling.animation.Tween
      {
         mTarget = param1;
         mCurrentTime = 0;
         mTotalTime = Math.max(1.0E-4,param2);
         mProgress = 0;
         mRepeatDelay = 0;
         mDelay = 0;
         mOnComplete = §§dup(null);
         mOnUpdate = §§dup(null);
         mOnStart = null;
         mOnCompleteArgs = §§dup(null);
         mOnUpdateArgs = §§dup(null);
         mOnStartArgs = null;
         mReverse = false;
         mRoundToInt = false;
         mRepeatCount = 1;
      ...
      public function animate(param1:String, param2:Number, param3:Number = NaN) : void
      {
         if(mTarget == null)
         {
            return;
      ...
      public function advanceTime(param1:Number) : void
      {
         ...
         var _loc3_:Number = param1 > _loc11_?param1 - _loc11_:0.0;
