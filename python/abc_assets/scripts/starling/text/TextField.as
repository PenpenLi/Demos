package starling.text
{
   ...
   public class TextField extends DisplayObjectContainer
   {
      ...
      private function renderText(param1:Number, param2:Rectangle) : BitmapData
      {
         ...
         {
            _loc5_ = 2.147483647E9;
            _loc6_ = "left";
         }
         if(isVerticalAutoSize)
         {
            _loc11_ = 2.147483647E9;
            _loc4_ = "top";
         }
         ...
         if(isHorizontalAutoSize)
         {
            _loc5_ = §§dup(Math.ceil(_loc10_ + 5));
            sNativeTextField.width = Math.ceil(_loc10_ + 5);
         }
         if(isVerticalAutoSize)
         {
            _loc11_ = §§dup(Math.ceil(_loc3_ + 4));
         ...
         var _loc14_:Matrix = new Matrix(1,0,0,1,_loc15_.x,_loc15_.y + _loc8_ - 2);
      ...
      private function createComposedContents() : void
      {
         ...
         if(isHorizontalAutoSize)
         {
            _loc4_ = 2.147483647E9;
            _loc3_ = "left";
         }
         if(isVerticalAutoSize)
         {
            _loc1_ = 2.147483647E9;
            _loc2_ = "top";
         }
