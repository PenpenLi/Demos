   ...
   public class RenderSupport
   {
      ...
      public static function assembleAgal(param1:String, param2:String, param3:Program3D = null) : Program3D
      {
         ...
         if(param3 == null)
         {
            ...
            var param3:Program3D = _loc4_.createProgram();
         }
      ...
      public function pushMatrix() : void
      {
         ...
         mMatrixStackSize = §§dup(mMatrixStackSize) + 1;
      ...
      {
         mMatrixStackSize = §§dup(mMatrixStackSize - 1);
         mModelViewMatrix.copyFrom(mMatrixStack[mMatrixStackSize - 1]);
      }
      ...
      public function pushClipRect(param1:Rectangle) : Rectangle
      {
         ...
         var param1:Rectangle = mClipRectStack[mClipRectStackSize];
      ...
      {
         mDrawCount = §§dup().mDrawCount + param1;
      }
