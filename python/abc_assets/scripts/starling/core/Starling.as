package starling.core
{
   ...
   public class Starling extends EventDispatcher
   {
      ...
      private var mSupport:starling.core.RenderSupport;
      ...
      private var mStatsDisplay:starling.core.StatsDisplay;
      ...
      public function Starling(param1:Class, param2:flash.display.Stage, param3:Rectangle = null, param4:Stage3D = null, param5:String = "auto", param6:Object = "baselineConstrained")
      {
         ...
         if(param3 == null)
         {
            var param3:Rectangle = new Rectangle(0,0,param2.stageWidth,param2.stageHeight);
         }
         if(param4 == null)
         {
            var param4:Stage3D = param2.stage3Ds[0];
         }
         ...
         mSupport = new starling.core.RenderSupport();
      ...
      private function requestContext3D(param1:Stage3D, param2:String, param3:Object) : void
      {
         ...
         if(profile == "auto")
         {
            var profiles:Array = ["baselineExtended","baseline","baselineConstrained"];
         }
      ...
      private function initializeGraphicsAPI() : void
      {
         ...
         updateViewPort(true);
         LogUtil("[Starling] Initialization complete.");
         LogUtil("[Starling] Display Driver:",mContext.driverInfo);
      ...
      public function render() : void
      {
         ...
         mSupport.setOrthographicProjection(mViewPort.x < 0?-mViewPort.x / _loc1_:0.0,mViewPort.y < 0?-mViewPort.y / _loc2_:0.0,mClippedViewPort.width / _loc1_,mClippedViewPort.height / _loc2_);
         if(!mShareContext)
         {
            starling.core.RenderSupport.clear(mStage.color,1);
         }
      ...
      {
         if(!starling.core.Starling.handleLostContext && mContext)
         {
            stop();
            param1.stopImmediatePropagation();
            showFatalError("Fatal error: The application lost the device context!");
            LogUtil("[Starling] The device context was lost. Enable \'Starling.handleLostContext\' to avoid this error.");
         }
         else
         {
            initialize();
      ...
      {
         deleteProgram(param1);
         var _loc4_:Program3D = starling.core.RenderSupport.assembleAgal(param2,param3);
         programs[param1] = _loc4_;
         return _loc4_;
      }
      ...
      public function showStatsAt(param1:String = "left", param2:String = "top", param3:Number = 1) : void
      {
         ...
         else
         {
            ...
            {
               mStatsDisplay = new starling.core.StatsDisplay();
            ...
            {
               mStatsDisplay.x = (stageWidth - mStatsDisplay.width) / 2;
            }
            if(vAlign == "top")
            {
               mStatsDisplay.y = 0;
            ...
            {
               mStatsDisplay.y = (stageHeight - mStatsDisplay.height) / 2;
            }
         }
      }
