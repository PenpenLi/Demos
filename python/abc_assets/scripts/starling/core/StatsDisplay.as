package starling.core
{
   ...
   class StatsDisplay extends Sprite
   {
      ...
      {
         mTotalTime = §§dup().mTotalTime + param1.passedTime;
      ...
      {
         mFps = mTotalTime > 0?mFrameCount / mTotalTime:0.0;
         mMemory = System.totalMemory * 9.54E-7;
         mTextField.text = "FPS: " + mFps.toFixed(mFps < 100?1:0.0) + "\nMEM: " + mMemory.toFixed(mMemory < 100?1:0.0) + "\nDRW: " + (mTotalTime > 0?mDrawCount - 2:mDrawCount);
      }
