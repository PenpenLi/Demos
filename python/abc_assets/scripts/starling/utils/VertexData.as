package starling.utils
{
   ...
   public class VertexData
   {
      ...
      public function clone(param1:int = 0, param2:int = -1) : VertexData
      {
         ...
         {
            var param2:int = mNumVertices - param1;
         }
      ...
      public function copyTransformedTo(param1:VertexData, param2:int = 0, param3:Matrix = null, param4:int = 0, param5:int = -1) : void
      {
         ...
         {
            var param5:int = mNumVertices - param4;
         }
      ...
      public function append(param1:VertexData) : void
      {
         ...
         mNumVertices = §§dup().mNumVertices + param1.numVertices;
         mRawData.fixed = true;
      }
      ...
      public function setColorAndAlpha(param1:int, param2:uint, param3:Number) : void
      {
         ...
         var _loc5_:Number = mPremultipliedAlpha?param3:1.0;
      ...
      public function setColor(param1:int, param2:uint) : void
      {
         ...
         var _loc4_:Number = mPremultipliedAlpha?mRawData[_loc3_ + 3]:1.0;
      ...
      public function getColor(param1:int) : uint
      {
         ...
         var _loc5_:Number = mPremultipliedAlpha?mRawData[_loc6_ + 3]:1.0;
         if(_loc5_ == 0)
         {
            return 0;
         }
         _loc2_ = mRawData[_loc6_] / _loc5_;
         _loc4_ = mRawData[_loc6_ + 1] / _loc5_;
         _loc3_ = mRawData[_loc6_ + 2] / _loc5_;
         return _loc2_ * 255 << 16 | _loc4_ * 255 << 8 | _loc3_ * 255;
      }
      ...
      public function scaleAlpha(param1:int, param2:Number, param3:int = 1) : void
      {
         ...
         {
            var param3:int = mNumVertices - param1;
         }
         if(mPremultipliedAlpha)
         {
            _loc5_ = 0;
      ...
      public function getBounds(param1:Matrix = null, param2:int = 0, param3:int = -1, param4:Rectangle = null) : Rectangle
      {
         ...
         if(param4 == null)
         {
            var param4:Rectangle = new Rectangle();
         }
         if(param3 < 0 || param2 + param3 > mNumVertices)
         {
            var param3:int = mNumVertices - param2;
         }
         if(param3 == 0)
         {
            if(param1 == null)
      ...
      public function toString() : String
      {
         ...
         while(_loc5_ < numVertices)
         {
            ...
            _loc2_ = _loc2_ + ("  [Vertex " + _loc5_ + ": " + "x=" + _loc1_.x.toFixed(1) + ", " + "y=" + _loc1_.y.toFixed(1) + ", " + "rgb=" + getColor(_loc5_).toString(16) + ", " + "a=" + getAlpha(_loc5_).toFixed(2) + ", " + "u=" + _loc3_.x.toFixed(4) + ", " + "v=" + _loc3_.y.toFixed(4) + "]" + (_loc5_ == numVertices - 1?"\n":",\n"));
            _loc5_++;
         }
         return _loc2_ + "]";
      }
      ...
      public function setPremultipliedAlpha(param1:Boolean, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               _loc4_ = mPremultipliedAlpha?_loc3_:1.0;
               _loc5_ = param1?_loc3_:1.0;
               if(_loc4_ != 0)
               {
