package starling.filters
{
   ...
   public class FragmentFilter
   {
      ...
      private function renderPasses(param1:DisplayObject, param2:RenderSupport, param3:Number, param4:Boolean = false) : QuadBatch
      {
         ...
         var _loc12_:Texture = param2.renderTarget;
         if(_loc12_)
         {
      ...
      {
         var _loc7_:* = 0;
         var _loc5_:int = mNumPasses > 1?2:1.0;
         var _loc6_:Boolean = mPassTextures == null || mPassTextures.length != _loc5_ || mPassTextures[0].width != param1 || mPassTextures[0].height != param2;
         if(_loc6_)
         {
            if(mPassTextures)
            {
               var _loc9_:* = 0;
               var _loc8_:* = mPassTextures;
      ...
      protected function assembleAgal(param1:String = null, param2:String = null) : Program3D
      {
         if(param1 == null)
         {
            var param1:String = "tex oc, v0, fs0 <2d, clamp, linear, mipnone>";
         }
         if(param2 == null)
         {
            var param2:String = "m44 op, va0, vc0 \nmov v0, va1      \n";
         }
