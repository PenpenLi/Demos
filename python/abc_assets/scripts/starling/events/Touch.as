package starling.events
{
   ...
   public class Touch
   {
      ...
      private var mBubbleChain:Vector.<starling.events.EventDispatcher>;
      ...
      public function Touch(param1:int)
      {
         ...
         mWidth = 1;
         mPressure = 1;
         mBubbleChain = new Vector.<starling.events.EventDispatcher>(0);
      }
      ...
      function get bubbleChain() : Vector.<starling.events.EventDispatcher>
      {
