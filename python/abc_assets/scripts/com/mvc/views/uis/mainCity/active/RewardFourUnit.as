package com.mvc.views.uis.mainCity.active
{
   ...
   public class RewardFourUnit extends Sprite
   {
       
      private var swf:Swf;
      
      private var spr_listBg2:SwfSprite;
      ...
      public function RewardFourUnit()
      {
         super();
         swf = LoadSwfAssetsManager.getInstance().assets.getSwf("activity");
         spr_listBg2 = swf.createSprite("spr_list2");
         btn_alreadyGet = spr_listBg2.getButton("btn_alreadyGet");
         btn_get = spr_listBg2.getButton("btn_get");
         btn_notGet = spr_listBg2.getButton("btn_notGet");
         title = spr_listBg2.getTextField("title");
         step = spr_listBg2.getTextField("step");
         step.autoScale = true;
         addChild(spr_listBg2);
         ...
         spr_listBg2.addChild(rewardCotain);
      ...
      public function set myActiveChild(param1:ActiveChildVO) : void
      {
         ...
         step.text = param1.doedTime + "/" + param1.reqNum;
