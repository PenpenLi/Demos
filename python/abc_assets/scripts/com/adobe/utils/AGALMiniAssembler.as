package com.adobe.utils
{
   ...
   public class AGALMiniAssembler
   {
      ...
      private static const EXP:String = "com.mvc.models.vos.fighting.currentExp";
      ...
      private static function init() : void
      {
         ...
         OPMAP["com.mvc.models.vos.fighting.currentExp"] = new OpCode("com.mvc.models.vos.fighting.currentExp",2,13,0);
      ...
      public function assemble(param1:String, param2:String, param3:uint = 1, param4:Boolean = false) : ByteArray
      {
         ...
         agalcode.writeByte(_loc46_?1:0.0);
         initregmap(param3,param4);
         var _loc25_:Array = param2.replace(new RegExp("[\\f\\n\\r\\v]+","g"),"\n").split("\n");
         var _loc21_:* = 0;
         var _loc32_:int = _loc25_.length;
         _loc42_ = 0;
         while(_loc42_ < _loc32_ && _error == "")
         {
            _loc30_ = new String(_loc25_[_loc42_]);
            ...
            _loc28_ = _loc30_.search(new RegExp("<.*>","g"));
            if(_loc28_ != -1)
            {
               _loc5_ = _loc30_.slice(_loc28_).match(new RegExp("([\\w\\.\\-\\+]+)","gi"));
               _loc30_ = _loc30_.slice(0,_loc28_);
            }
            _loc34_ = _loc30_.match(new RegExp("^\\w{3}","gi"));
            if(!_loc34_)
            {
               if(_loc30_.length >= 3)
               {
                  LogUtil("warning: bad line " + _loc42_ + ": " + _loc25_[_loc42_]);
               }
            }
            else
            {
               ...
               else
               {
                  ...
                  _loc17_ = _loc30_.match(new RegExp("vc\\[([vof][acostdip]?)(\\d*)?(\\.[xyzw](\\+\\d{1,3})?)?\\](\\.[xyzw]{1,4})?|([vof][acostdip]?)(\\d*)?(\\.[xyzw]{1,4})?","gi"));
                  ...
                  {
                     _loc35_ = false;
                     _loc16_ = _loc17_[_loc40_].match(new RegExp("\\[.*\\]","gi"));
                     ...
                     _loc27_ = _loc17_[_loc40_].match(new RegExp("^\\b[A-Za-z]{1,2}","gi"));
                     if(!_loc27_)
                     {
                     ...
                     _loc15_ = _loc35_?_loc16_[0].match(new RegExp("\\d+")):_loc17_[_loc40_].match(new RegExp("\\d+"));
                     _loc19_ = 0;
                     if(_loc15_)
                     {
                        _loc19_ = _loc15_[0];
                     ...
                     _loc48_ = 0;
                     _loc49_ = _loc17_[_loc40_].match(new RegExp("(\\.[xyzw]{1,4})"));
                     ...
                     {
                        _loc48_ = 0;
                        _loc31_ = _loc49_[0].length;
                        _loc41_ = 1;
                        while(_loc41_ < _loc31_)
                        {
                           _loc18_ = _loc49_[0].charCodeAt(_loc41_) - "x".charCodeAt(0);
                           if(_loc18_ > 2)
                           {
                              _loc18_ = 3;
                           }
                           if(_loc33_)
                           {
                              _loc48_ = _loc48_ | 1 << _loc18_;
                           }
                           else
                           {
                              _loc48_ = _loc48_ | _loc18_ << _loc41_ - 1 << 1;
                           }
                           _loc41_++;
                        }
                        if(!_loc33_)
                     ...
                     if(_loc35_)
                     {
                        _loc11_ = _loc16_[0].match(new RegExp("[A-Za-z]{1,2}","gi"));
                        ...
                        _loc6_ = _loc16_[0].match(new RegExp("(\\.[xyzw]{1,1})"));
                        if(_loc6_.length == 0)
                        {
                        ...
                        _loc20_ = _loc6_[0].charCodeAt(1) - "x".charCodeAt(0);
                        if(_loc20_ > 2)
                        {
                           _loc20_ = 3;
                        }
                        _loc38_ = _loc16_[0].match(new RegExp("\\+\\d{1,3}","gi"));
                        if(_loc38_.length > 0)
                        {
                           _loc8_ = _loc38_[0];
                        }
                        ...
                        if(verbose)
                        {
                           LogUtil("RELATIVE: type=" + _loc24_ + "==" + _loc11_[0] + " sel=" + _loc20_ + "==" + _loc6_[0] + " idx=" + _loc19_ + " offset=" + _loc8_);
                        }
                     }
                     if(verbose)
                     {
                        LogUtil("  emit argcode=" + _loc9_ + "[" + _loc19_ + "][" + _loc48_ + "]");
                     }
                     if(_loc33_)
                     {
                     ...
                     else if(_loc7_)
                     {
                        if(verbose)
                        {
                           LogUtil("  emit sampler");
                        }
                        _loc45_ = 5;
                        _loc13_ = _loc5_ == null?0:_loc5_.length;
                        _loc12_ = 0.0;
                        _loc41_ = 0;
                        while(_loc41_ < _loc13_)
                        {
                           if(verbose)
                           {
                              LogUtil("    opt: " + _loc5_[_loc41_]);
                           }
                           _loc44_ = SAMPLEMAP[_loc5_[_loc41_]];
                           if(_loc44_ == null)
                           {
                              _loc12_ = _loc5_[_loc41_];
                              if(verbose)
                              {
                                 LogUtil("    bias: " + _loc12_);
                              }
                           }
                           else
                           {
                              if(_loc44_.flag != 16)
                              {
                                 _loc45_ = _loc45_ & ~(15 << _loc44_.flag);
                              }
                              _loc45_ = _loc45_ | _loc44_.mask << _loc44_.flag;
                           }
                           _loc41_++;
                        }
                        agalcode.writeShort(_loc19_);
                        agalcode.writeByte(_loc12_ * 8);
                        agalcode.writeByte(0);
                        agalcode.writeUnsignedInt(_loc45_);
                        if(verbose)
                        {
                           LogUtil("    bits: " + (_loc45_ - 5));
                        }
                        _loc39_ = _loc39_ - 64;
                     }
                     else
         ...
         if(debugEnabled)
         {
            ...
            while(_loc14_ < _loc37_)
            {
               ...
               _loc47_ = agalcode[_loc14_].toString(16);
               if(_loc47_.length < 2)
               {
                  _loc47_ = "0" + _loc47_;
               }
               _loc36_ = _loc36_ + _loc47_;
               _loc14_++;
            }
            LogUtil(_loc36_);
         }
         if(verbose)
         {
            LogUtil("AGALMiniAssembler.assemble time: " + (getTimer() - _loc23_) / 1000 + "s");
         }
         return agalcode;
      }
      ...
      {
         REGMAP["va"] = new Register("va","vertex attribute",0,param2?1024:7.0,64 | 2);
         REGMAP["vc"] = new Register("vc","vertex constant",1,param2?1024:param1 == 1?127:250,64 | 2);
         REGMAP["vt"] = new Register("vt","vertex temporary",2,param2?1024:param1 == 1?7:27.0,64 | 1 | 2);
         REGMAP["vo"] = new Register("vo","vertex output",3,param2?1024:0.0,64 | 1);
         REGMAP["vi"] = new Register("vi","varying",4,param2?1024:param1 == 1?7:11.0,64 | 32 | 2 | 1);
         REGMAP["fc"] = new Register("fc","fragment constant",1,param2?1024:param1 == 1?27:63.0,32 | 2);
         REGMAP["ft"] = new Register("ft","fragment temporary",2,param2?1024:param1 == 1?7:27.0,32 | 1 | 2);
         REGMAP["fs"] = new Register("fs","texture sampler",5,param2?1024:7.0,32 | 2);
         REGMAP["fo"] = new Register("fo","fragment output",3,param2?1024:param1 == 1?0:3.0,32 | 1);
         REGMAP["fd"] = new Register("fd","fragment depth output",6,param2?1024:param1 == 1?-1:0.0,32 | 1);
         REGMAP["op"] = REGMAP["vo"];
         REGMAP["i"] = REGMAP["vi"];
         REGMAP["v"] = REGMAP["vi"];
         REGMAP["oc"] = REGMAP["fo"];
