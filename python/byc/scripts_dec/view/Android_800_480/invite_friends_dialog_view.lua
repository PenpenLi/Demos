...
{
	name="invite_friends_dialog_view",type=0,typeName="View",time=0,x=0,y=0,width=0,height=0,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
	{
		...
		{
			name="chat_room_list",type=0,typeName="View",time=114590313,x=0,y=171,width=643,height=448,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop
		}
	}
}