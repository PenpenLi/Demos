find_own_create_endgate_view=
{
	...
	},
	{
		...
		{
			name="Text1",type=4,typeName="Text",time=114754495,x=0,y=0,width=152,height=38,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,fontSize=42,textAlign=kAlignLeft,colorRed=125,colorGreen=65,colorBlue=80,string=[[我创建的]]
		}
	},
	{
