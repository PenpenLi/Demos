	...
	name="union_dialog_view",type=0,typeName="View",time=0,x=0,y=0,width=0,height=0,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignCenter,
	{
		...
		},
		{
			...
			},
			{
				...
				{
					name="prompt_textview",type=5,typeName="TextView",time=106135908,x=0,y=120,width=365,height=190,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,fontSize=36,textAlign=kAlignCenter,colorRed=80,colorGreen=80,colorBlue=80,string=[[同城相关功能需要选择所在地区后才可以使用]]
				},
				{
				...
				},
				{
					...
					{
						name="recommend_view",type=0,typeName="View",time=114164690,x=0,y=107,width=587,height=291,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop
					},
					{
