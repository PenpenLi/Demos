replay_view=
{
	...
	},
	{
		...
		},
		{
			...
			{
				name="tips",type=4,typeName="Text",time=111643325,x=0,y=7,width=112,height=28,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom,fontSize=28,textAlign=kAlignCenter,colorRed=100,colorGreen=100,colorBlue=100,string=[[公开收藏]]
			},
			{
