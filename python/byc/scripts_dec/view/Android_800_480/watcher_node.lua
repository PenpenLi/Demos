watcher_node=
{
	name="watcher_node",type=0,typeName="View",time=0,x=0,y=0,width=0,height=0,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopLeft,
	{
		...
		{
			name="name_score",type=0,typeName="View",time=110629187,x=0,y=20,width=155,height=60,visible=1,fillParentWidth=1,fillParentHeight=0,nodeAlign=kAlignCenter,
			{
