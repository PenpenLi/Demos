hall_view=
{
	...
	},
	{
		name="userinfo_view",type=0,typeName="View",time=93433187,x=-75,y=15,width=350,height=126,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,
		{
			...
			{
				name="money_view",type=0,typeName="View",time=93507055,x=10,y=0,width=166,height=50,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignLeft
			},
			{
	...
	{
		name="rank_btn_bg",type=1,typeName="Image",time=110366526,x=172,y=-23,width=82,height=150,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,file="common/decoration/top_cloth_5.png",
		{
			name="rank_btn",type=2,typeName="Button",time=110366061,x=0,y=0,width=80,height=84,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignCenter,file="hall/rank_nor.png",file2="hall/rank_pre.png",
			{
