replay_view2=
{
	name="replay_view2",type=0,typeName="View",time=0,x=0,y=0,width=720,height=1280,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
	{
	...
	},
	{
		...
		{
			name="title_bg",type=1,typeName="Image",time=94471282,x=0,y=0,width=720,height=106,visible=1,fillParentWidth=1,fillParentHeight=0,nodeAlign=kAlignTopLeft,file="common/decoration/top_borad.png"
		},
		{
	...
	},
	{
		name="btns_content",type=0,typeName="View",time=111641132,x=0,y=143,width=630,height=100,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,
		{
			...
			},
			{
				...
				{
					name="btn_txt",type=4,typeName="Text",time=111642424,x=0,y=18,width=144,height=36,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,fontSize=36,textAlign=kAlignLeft,colorRed=255,colorGreen=255,colorBlue=255,string=[[]]
				}
			},
			{
				name="tips",type=4,typeName="Text",time=111642071,x=0,y=11,width=70,height=28,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom,fontSize=28,textAlign=kAlignCenter,colorRed=100,colorGreen=100,colorBlue=100,string=[[]]
			},
			{
		...
		},
		{
			...
			},
			{
				...
				{
					name="btn_txt",type=4,typeName="Text",time=111643291,x=0,y=18,width=144,height=36,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,fontSize=36,textAlign=kAlignLeft,colorRed=255,colorGreen=255,colorBlue=255,string=[[]]
				}
			},
			{
				name="tips",type=4,typeName="Text",time=111643292,x=0,y=11,width=70,height=28,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom,fontSize=28,textAlign=kAlignCenter,colorRed=100,colorGreen=100,colorBlue=100,string=[[]]
			},
			{
		...
		},
		{
			...
			},
			{
				...
				{
					name="btn_txt",type=4,typeName="Text",time=111643324,x=0,y=18,width=144,height=36,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,fontSize=36,textAlign=kAlignLeft,colorRed=255,colorGreen=255,colorBlue=255,string=[[]]
				}
			},
			{
				name="tips",type=4,typeName="Text",time=111643325,x=0,y=11,width=112,height=28,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignBottom,fontSize=28,textAlign=kAlignCenter,colorRed=100,colorGreen=100,colorBlue=100,string=[[]]
			},
			{
	...
	{
		name="help_btn",type=2,typeName="Button",time=112342679,x=135,y=0,width=86,height=90,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopRight,file="common/button/help_nor.png",file2="common/button/help_pre.png"
	}
}