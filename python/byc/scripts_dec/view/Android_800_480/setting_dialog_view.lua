setting_dialog_view=
{
	name="setting_dialog_view",type=0,typeName="View",time=0,x=0,y=0,width=480,height=800,visible=1,fillParentWidth=1,fillParentHeight=1,nodeAlign=kAlignTopLeft,
	{
		...
		{
			name="Text1",type=4,typeName="Text",time=96112319,x=0,y=66,width=110,height=44,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,fontSize=44,textAlign=kAlignLeft,colorRed=80,colorGreen=80,colorBlue=80,string=[[设 置]]
		},
		{
			name="Image2",type=1,typeName="Image",time=96112383,x=0,y=146,width=640,height=19,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTop,file="common/decoration/line.png"
		},
		{
		...
		{
			name="close_btn",type=2,typeName="Button",time=102140507,x=43,y=55,width=60,height=60,visible=1,fillParentWidth=0,fillParentHeight=0,nodeAlign=kAlignTopRight,file="common/button/btn_close.png"
		}
	}
}