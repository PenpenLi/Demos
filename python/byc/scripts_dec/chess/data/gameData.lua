...
--下载apk的url
GameData.getUpdateUrl = function(self)
    return  self.m_updateUrl;
end
...
--升级数据
GameData.setUpdateData = function(self,updateData)
    self.m_updateData = updateData;
end

GameData.getUpdateData = function(self)
    return self.m_updateData;
end

--标记是否需要提醒用户安装
GameData.setInstallUpdate = function(self,flag)
    self.m_installUpdate = flag;
end

GameData.getInstallUpdate = function(self)
    return self.m_installUpdate;
end

--标志强制升级数据
GameData.setForceFlag = function(self,updateData)
    self.m_forceFlag = updateData;
end

GameData.getForceFlag = function(self)
    return self.m_forceFlag;
end
