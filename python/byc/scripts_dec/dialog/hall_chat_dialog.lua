...
HallChatDialog.addDashiChatRoom = function(self,name,message,uid,time)
    ...
    local event = SchemesProxy.analyzeSchemesStr(data.msg);
    if type(event) == "function" then
	    local item = new(HallChatRoomSchemesItem,self,data,event);
...
HallChatDialog.leftOutRightIn = function(self,leftView, rightView,callBackFun)
    ...
    -- rightTransparency
    local rightTransparency = rightView:addPropTransparency(1,kAnimNormal,HallChatDialog.LORI_ANIM_TIME,0,0,0.05);
...
HallChatDialog.leftInRightOut = function(self,leftView, rightView,callBackFun)
    ...
    -- rightTransparency
    local rightTransparency = rightView:addPropTransparency(2,kAnimNormal,HallChatDialog.LORI_ANIM_TIME,0,0.05,0);
    if not rightTransparency then return end;
    rightTransparency:setEvent(nil, function() 
...
function HallChatRoomSchemesItem.ctor(self,handler,data,event)
    ...
    self.mNameView:setText(self.mName);
