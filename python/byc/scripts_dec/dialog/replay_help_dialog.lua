...
ReplayHelpDialog.CONTENT = {
                            ...
                            [2] = {["title"] = "清空对局：",["content"] = "使用清空可一次性清空最近对局中的所有棋谱。"},
                            [3] = {["title"] = "我的收藏：",["content"] = "所收藏的棋谱可一直保留，方便随时演练；公开收藏为所有人可见，私密仅自己可见。点击棋谱下方的私密/公开按钮可切换棋谱的收藏方式。"},
                            [4] = {["title"] = "棋友推荐：",["content"] = "可随时查看自己和好友公开收藏的棋谱，可以转收藏或评论喜欢的棋谱，若公开收藏的棋谱被好友转收藏，可以获得金币奖励。"},
                            [5] = {["title"] = "评论：",    ["content"] = "可随时评价自己和棋友公开收藏的棋谱，所有人可见。"},
                           };
