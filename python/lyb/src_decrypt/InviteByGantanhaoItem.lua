...
function InviteByGantanhaoItem:initialize(skeleton, container_parent, data, container)
  ...
  local text='<content><font color="#FFFFFF" ref="1">' .. self.data.UserName .. '</font></content>';
  ...
  text='<content><font color="#FFFFFF">Lv' .. (self.data.Level and self.data.Level or "0") .. '</font></content>';
