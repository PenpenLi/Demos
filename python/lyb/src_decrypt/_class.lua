...
-- Lua面向对象实现
-- by 云风
-- (c) copyright 2009 - 2013, blog.codingnow.com
-- All Rights Reserved. 
--=======================================
-- filename:  class.lua
-- author:    云风
-- e-mail:      cloudwu@gamil.com
-- created:   2006/10/30
-- descrip:   使用Lua的table实现OOP编程
--=======================================
...
function class(super)
    ...
    class_type.new = function(...)
        ...
        setmetatable(obj,{ __index=
        	function(t,k)
        		-- if k ~= "isDisposed" then
	        	-- 	local disposedFlag = rawget(obj,"isDisposed")
	        	-- 	if disposedFlag then
	        	-- 		he_log_WriteToTempFile("dispose true -- key=" .. k,false)
	        	-- 	end
	        	-- end
