...
HeroJinJiePopup=class(LayerPopableDirect);

function HeroJinJiePopup:ctor()
  self.class=HeroJinJiePopup;
end

function HeroJinJiePopup:dispose()
	HeroJinJiePopup.superclass.dispose(self);
  -- self.removeArmature:dispose();
end

function HeroJinJiePopup:onDataInit()
...
function HeroJinJiePopup:initialize()
  -- self:initLayer();
...
function HeroJinJiePopup:onPrePop()
...
function HeroJinJiePopup:onUIInit()
...
function HeroJinJiePopup:onRequestedData()
