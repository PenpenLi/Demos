...
local cTable = {
    ...
    {"2", "后退1步", "30000807400102", "140121023050", "2.5"}, 
...
function SmsPay:testPurchaseItem()
    ...
    print("Info - Keypad Callback: payment purchaseItem[" .. tostring(itemId) .. "]")
    ...
    self:purchaseItem(itemId, 1, 1, 1, 
        function(code) 
            ...
            print("Info - Keypad Callback: payment code[" .. tostring(code) .. "], purchaseItem[" .. tostring(itemId) .. "]")
        end
    )
