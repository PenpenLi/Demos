...
function MissionManager:onMissionStateChanged(missionData , oldState)
	...
	print("MF   MissionFrameEvent.kStateChanged  id = " .. tostring(missionData:getId()) )
end
...
function MissionManager:onMissionProgressChanged(condition , oldValue , oldProgress)
	...
	print("MF   MissionFrameEvent.kProgressChanged  id = " .. tostring(condition:getMissionId()) )
end

---------------------------------------------------------------------------------

function MissionManager:addLevelMissionMap(level , missionId )
	print("RRR   MissionManager:addLevelMissionMap    " , level , missionId)
...
function MissionManager:removeLevelMissionMap(level , missionId)
	print("RRR   MissionManager:removeLevelMissionMap    " , level , missionId)
