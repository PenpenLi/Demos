...
function MissionBugTip:showTips(tipType , propId , callback , data)
	...
	elseif tipType == 4 then
		...
		--print("RRR  BUGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG   1")
		local levelId = data
		local missionId = MissionManager:getInstance():getMissionIdOnLevel(levelId)[1]

		if missionId then
			--print("RRR  BUGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG   2")
			...
			--print("RRR  BUGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG   3")
			if missionData then
				--print("RRR  BUGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG   4")
