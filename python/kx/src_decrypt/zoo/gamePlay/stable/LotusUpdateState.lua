...
function LotusUpdateState:tryLotusUpdate()
    ...
    if mainLogic.isBonusTime then
    	print("RRR    LotusUpdateState   ---------------------------  return 1")
    ...
    for r = 1, #boardmap do
        for c = 1, #boardmap[r] do
            board = boardmap[r][c]
            if board and board.lotusLevel > 0 then
    ...
    if #lotusBoards == 0 or mainLogic.lotusEliminationNum ~= mainLogic.lotusPrevStepEliminationNum then
    	print("RRR    LotusUpdateState   ---------------------------  return 2    " , 
	...
	local function isAvailableItem(item , board)
		...
		if item 
			...
			and board and board.isUsed and board.lotusLevel == 0 and not board.isReverseSide then
			return true
		end
		return false
	end
	...
	for k, board in pairs(lotusBoards) do
		...
		if not board_center.isReverseSide then
			item = nil
	...
	for k, board in pairs(lotusBoards_level_1) do
		...
		--草地只能捆住普通小动物、直线特效、爆炸特效、水晶球、倒计时炸弹、+5步动物、倒计时炸弹和大眼仔
		if item_center and 
			...
			(
				...
				item_center.ItemType == GameItemType.kAnimal
	...
	for k, board in pairs(lotusBoards_level_2) do
		...
		if not board.isReverseSide then
	...
	if #level_1_canCreateList > 0 then
		...
		elseif #level_3_canCreateList > 0 then
			...
			print("RRR    LotusUpdateState   ---------------------------  return 3")
			self:onActionComplete()
       		return
		end
	end
	print("RRR    +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	print("RRR    +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	print("RRR    LotusUpdateState   Random result :")
	print("RRR    rate_1 :" , rate_1)
	print("RRR    rate_2 :" , rate_2)
	print("RRR    rate_3 :" , rate_3)
	print("RRR    +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	print("RRR    +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	rate_1 = rate_1 * 1000
	rate_2 = rate_2 * 1000
