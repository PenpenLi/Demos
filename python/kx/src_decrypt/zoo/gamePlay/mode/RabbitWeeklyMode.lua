...
function RabbitWeeklyMode:initModeSpecial(config)
    -- print('RabbitWeeklyMode RabbitWeeklyMode RabbitWeeklyMode initModeSpecial')
    self.stage = 0
...
function RabbitWeeklyMode:enterNextStage()
    ...
    -- print('RabbitWeeklyMode:enterNextStage', self.stage)
end
...
function RabbitWeeklyMode:getGenerateCount_backup(realCostMove)
    ...
    -- print('curRabbitCount', curRabbitCount)
    -- print('maxGenCount', maxGenCount)
    -- print('shouldGenerateCount', shouldGenerateCount)
