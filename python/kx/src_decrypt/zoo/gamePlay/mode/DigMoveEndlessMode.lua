...
function DigMoveEndlessMode:afterFail()
	print('DigMoveEndlessMode:afterFail')
...
function DigMoveEndlessMode:generateGroundRow(rowCount)
	...
	print('self.rowCountSinceLastGroundUpgrade', self.rowCountSinceLastGroundUpgrade)
	print('self.rowCountSinceLastAddMove', self.rowCountSinceLastAddMove)
	print('self.rowCountSinceLastJewelUpgrade', self.rowCountSinceLastJewelUpgrade)
	...
	if shouldAddMove then
		print('GEN Add Move', self.rowCountSinceLastAddMove)
