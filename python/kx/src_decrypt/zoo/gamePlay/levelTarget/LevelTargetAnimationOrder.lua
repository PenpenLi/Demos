...
function LevelTargetAnimationOrder:create( topX )
	-- body
...
function LevelTargetAnimationOrder:createIcon( itemType, id, width, height )
	-- body
	local fullname = self:getIconFullName(itemType, id)
...
function LevelTargetAnimationOrder:setNumberOfTargets( v, animationCallbackFunc, flyFinishedCallback )
	-- body
...
function LevelTargetAnimationOrder:flyTarget( animationCallbackFunc, flyFinishedCallback )
