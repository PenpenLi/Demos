...
function LevelTargetAnimationTime:setNumberOfTargets( v, animationCallbackFunc, flyFinishedCallback )
	-- body
...
function LevelTargetAnimationTime:flyTimeTarget()
...
function LevelTargetAnimationTime:flyTarget( animationCallbackFunc, flyFinishedCallback )
	-- body
...
function LevelTargetAnimationMove:flyTarget( animationCallbackFunc, flyFinishedCallback )
	-- body
	if self.isTargetFly then return end
	self.isTargetFly = true
	local panel = self.panel
