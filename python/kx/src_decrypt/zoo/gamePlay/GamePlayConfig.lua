GamePlayConfigScoreMemClass = memory_class()
...
function GamePlayConfigScoreMemClass:encryptionFunc( key, value )
	if type(value) == "number" then
		...
		HeMemDataHolder:setInteger(GamePlayConfigScoreMemClass.getEncryptKey(key), value)
		return true
	end
	return false
end
...
function GamePlayConfigScoreMemClass:decryptionFunc( key )
	if encryptKeys[key] then
		return HeMemDataHolder:getInteger(GamePlayConfigScoreMemClass.getEncryptKey(key))
	end
	return false
end
