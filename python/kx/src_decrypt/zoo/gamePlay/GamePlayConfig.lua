...
GamePlayConfig_SwapAction_CD = 6 * GamePlayConfig_Action_FPS_Time_Scale				--帧动画数量--开始交换的动画播放时间
GamePlayConfig_SwapAction_Failed_CD = 8 * GamePlayConfig_Action_FPS_Time_Scale			--交换失败回弹时间
...
GamePlayConfig_IceDeleted_Pos_Add_X = 2
GamePlayConfig_IceDeleted_Pos_Add_Y = -18						----!!!冰层动画的偏移量，因为冰层动画范围比一个格子要大
...
-- 金豆荚
GamePlayConfig_Score_DropDown_Ingredient = 10000											-- 收集得分
...
GamePlayConfig_Hammer_Animation_CD = 10 * GamePlayConfig_Action_FPS_Time_Scale 			-- 锤子的动画播放时间
...
GamePlayConfig_LineBrush_Animation_CD = 10 * GamePlayConfig_Action_FPS_Time_Scale		    -- 条纹刷子的等待动画播放时间（此时间过后目标的类型即被转换）
...
GamePlayConfig_Score_Swap_WrapWrap = 1500 					----交换两个区域特效附加分数
GamePlayConfig_Score_Swap_ColorAnimal = 300 				----交换鸟和普通动物
GamePlayConfig_Score_Swap_ColorLine = 2000 					----交换鸟和直线
GamePlayConfig_Score_Swap_ColorWrap = 2500 					----交换鸟和区域
GamePlayConfig_Score_Swap_ColorColor = 5000 				----交换鸟鸟

GamePlayConfig_Score_MatchDeleted_Base = 10 				----消除单个动物的基础奖励分数
GamePlayConfig_Score_MatchDeleted_Crystal = 100 			----消除单个水晶的分数

GamePlayConfig_Score_MatchAt_Lock = 100 					----消除牢笼的得分
GamePlayConfig_Score_MatchAt_Ice = 1000 					----消除冰层的得分

GamePlayConfig_Score_Furball = 100 							----消除灰色毛球得分
GamePlayConfig_Score_Balloon = 100                          ----消除气球得分
GamePlayConfig_Score_Rabbit  = 500
GamePlayConfig_Score_MatchAt_DigGround = 100                ----消除地块得分
...
GamePlayConfig_Score_Roost = 400
