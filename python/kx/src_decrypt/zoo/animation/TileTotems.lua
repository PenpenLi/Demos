...
local BodyAdjustColorHSBC = {
	...
	[AnimalTypeConfig.kOrange] = {0.1353, -0.1501, 0.0153, 0.0899}, --{0.1796, -0.2635, 0.0477, 0.1677},
	[AnimalTypeConfig.kPurple] = {-0.5391, -0.1555, 0.0239, 0.2401},
	[AnimalTypeConfig.kRed] = {0, 0, 0, 0},
	[AnimalTypeConfig.kYellow] = {0.2520, 0.2639, 0.3838, 0.1796},
}
...
function TileTotemsAnimation:createTileLight()
	...
	local sprite = Sprite:createWithSpriteFrameName("super_totems_idle_0000")
