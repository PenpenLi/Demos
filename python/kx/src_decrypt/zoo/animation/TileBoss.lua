...
BossType = table.const
{
	kStarfish = {
		...
		water = {name = 'boss_water', frame = 34},
	},
}
...
function TileBoss:create(bossType)
	...
	node.bossType = bossType or BossType.kStarfish
...
function TileBoss:initBoss( ... )
	...
	self.boss:setPosition(ccp(10-70 + OFFSET_X, 70 - 25 + OFFSET_Y))
	self:createBloodBar()
	self:normal()
