...
local CrystalStoneBodyHSBC = {
	[AnimalTypeConfig.kRed] = {-0.2398, -0.1198, -0.2149, 0.1915},
	[AnimalTypeConfig.kBlue] = {0.8712, -0.3273, -0.0712, 0.2952},
	[AnimalTypeConfig.kGreen] = {0.3601, -0.3435, -0.0236, 0.2876},
	[AnimalTypeConfig.kPurple] = {-0.7261, -0.3511, -0.2311, 0.1201},
	[AnimalTypeConfig.kYellow] = {0, 0, 0, 0},
	[AnimalTypeConfig.kOrange] = {-0.1673, -0.4310, -0.2473, 0.2477},
}

local CrystalStoneEyesHSBC = {
	[AnimalTypeConfig.kRed] = {-0.25, 0, 0, 0},
	[AnimalTypeConfig.kBlue] = {0.5, 0, 0, 0},
	[AnimalTypeConfig.kGreen] = {0.082, 0, 0, 0},
	[AnimalTypeConfig.kPurple] = {-0.336, 0, 0, 0},
	[AnimalTypeConfig.kYellow] = {0, 0, 0, 0},
	[AnimalTypeConfig.kOrange] = {-0.164, 0.078, -0.07, 0.02},
}
...
function TileCrystalStoneAnimate:buildWater(color)
	...
	TileCrystalStoneAnimate:_useAdjustColor(waterSprite, getColorHSBC(CrystalStoneChargeEffectHSBC, color))
	...
	waveClippingNode:setContentSize(CCSizeMake(clippingW*0.94, clippingH))
	...
	TileCrystalStoneAnimate:_useAdjustColor(waveSprite, getColorHSBC(CrystalStoneChargeEffectHSBC, color))
...
function TileCrystalStoneAnimate:buildExplodeEffect(onFinishCallback)
	...
	local function addCircle3()
		...
		circle3Seq:addObject(CCScaleTo:create(7*AnimationTimePerFrame, 761/206*circle2Scale))
		circle3Seq:addObject(CCSpawn:createWithTwoActions(CCScaleTo:create(7*AnimationTimePerFrame, 1316/206*circle2Scale), CCFadeTo:create(7*AnimationTimePerFrame, 25.5)))
	...
	circle1Seq:addObject(CCSpawn:createWithTwoActions(CCScaleTo:create(3*AnimationTimePerFrame, 1), CCFadeTo:create(3*AnimationTimePerFrame, 255)))
	local circle1_1_1 = CCSpawn:createWithTwoActions(CCScaleTo:create(2*AnimationTimePerFrame, 0.9), CCFadeTo:create(2*AnimationTimePerFrame, 0))
	local circle1_1_2 = CCSpawn:createWithTwoActions(CCScaleTo:create(2*AnimationTimePerFrame, 1), CCFadeTo:create(2*AnimationTimePerFrame, 255))
	local circle1_1 = CCSequence:createWithTwoActions(circle1_1_1, circle1_1_2)
	circle1Seq:addObject(CCRepeat:create(circle1_1, 4))
	circle1Seq:addObject(CCSpawn:createWithTwoActions(CCScaleTo:create(2*AnimationTimePerFrame, 0.9), CCFadeTo:create(2*AnimationTimePerFrame, 0)))
	circle1Seq:addObject(CCFadeTo:create(AnimationTimePerFrame, 255))
	circle1Seq:addObject(CCScaleTo:create(5*AnimationTimePerFrame, 1))
	...
	circle3:setOpacity(0)
	circle3:runAction(CCSequence:createWithTwoActions(CCDelayTime:create(3*AnimationTimePerFrame), CCFadeTo:create(AnimationTimePerFrame, 255 * 0.5)))
