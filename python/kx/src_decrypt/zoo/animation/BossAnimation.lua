...
function BossAnimation:playUseAnimation(callback)
    ...
    FrameLoader:loadArmature("skeleton/season_weekly_boss_animation", "boss_starfish_animation", "boss_starfish_animation")
    local anim = ArmatureNode:create("starfish_big_animation/biganhaixing")
    anim:setPositionXY(vo.x + vs.width / 2 - 110, vo.y + vs.height * 6 / 14 + 80)
    anim:update(0.001)
...
function BossAnimation:buildItemIcon()
    ...
    local normal_nut = Sprite:createWithSpriteFrameName('weekly_normal_item_0000')
    local shine_bg = Sprite:createWithSpriteFrameName('weekly_shine_bg_0000')
    local shine_nut = Sprite:createWithSpriteFrameName('weekly_shine_item_0000')
    local bubble = Sprite:createWithSpriteFrameName('weekly_item_bubble_0000')
    local grey_nut = Sprite:createWithSpriteFrameName('weekly_grey_item_0000')
    ...
    normal_nut:setPosition(ccp(centerX, centerY - 2))
    ...
    container.playFlyNut = function (_self)
        ...
        local container = Layer:create()
        local nut = Sprite:createWithSpriteFrameName('weekly_normal_item_0000')
        local goldNut = Sprite:createWithSpriteFrameName('weekly_gold_item_0000')
