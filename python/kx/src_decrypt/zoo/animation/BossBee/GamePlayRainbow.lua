...
function GamePlayRainbow:initScheduler()
    ...
    local function callback(dt)
        ...
        -- print(self.currentPercent, self.startPercent, self.targetPercent)
        if self.currentPercent ~= self.targetPercent then
            ...
            -- print('dt', dt, 'targetPercent', self.targetPercent, 'startPercent', self.startPercent, 'currentPercent', self.currentPercent, 'nextPercent', nextPercent)
...
function GamePlayRainbow:setMark(position, angle, percent)
    -- print('setMark', position.x, position.y, angle)
...
function GamePlayRainbow:setPercent(percent)
    print('QAAAAAAAAAAAAAAAAAAAAAAAAA setPercent', percent)
    -- debug.debug()
