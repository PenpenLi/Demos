...
function PayPanelOneYuanMulti:initInnerPanel()
	...
	local btnShowConfig1 = PaymentManager.getInstance():getPaymentShowConfig(self.paymentTable[1])
	...
	local btnShowConfig2 = PaymentManager.getInstance():getPaymentShowConfig(self.paymentTable[2])
