...
function ScoreProgressAnimation:create(scoreProgress, pos)
	-- body
...
function ScoreProgressAnimation:init( scoreProgress, pos )
	-- body
	...
	if __frame_ratio and __frame_ratio < 1.6 then  self.kPropListScaleFactor = 0.92 end
...
function ScoreProgressAnimation:setStarsPosition( star1progress, star2progress, star3progress )	
...
function ScoreProgressAnimation:setStarsScore( star1score, star2score, star3score )
