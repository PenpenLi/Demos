...
function FlyItemsAnimation:create( rewards )
	local flyItems = FlyItemsAnimation.new(CCNode:create())
	flyItems:init(rewards)
	return flyItems
end

function FlyItemsAnimation:init( rewards )
