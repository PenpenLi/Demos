...
function AndroidSalesBasePanel:init(ui)
    ...
    local btnShowConfig = PaymentManager.getInstance():getPaymentShowConfig(self.mainPayment)
    ...
    if self.otherPaymentTable and #self.otherPaymentTable>0 then
        ...
        local btnShowConfigOhter = PaymentManager.getInstance():getPaymentShowConfig(anohterPayment)
