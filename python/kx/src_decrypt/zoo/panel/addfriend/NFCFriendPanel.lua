local NFCFriendPanel = class(BasePanel)

function NFCFriendPanel:create()
	local panel = NFCFriendPanel.new()
...
function NFCFriendPanel:init()
	self.ui = self:buildInterfaceGroup("NFCFriendPanel")
    ...
    self.title:setPreferredSize(371, 72)
...
function NFCFriendPanel:initContent()
	--local content = self.ui:getChildByName("content")
	--print("desc: ", tostring(content:getChildByName("lbl_desc")))
...
-- TabShake
------------------------------------------
function NFCFriendPanel:_tabShake_init(ui)
	-- get & create controls
	self.tabShake = {}
	self.tabShake.ui = ui
...
function NFCFriendPanel:_tabShake_waitForShake()
...
function NFCFriendPanel:_tabShake_searchFriend(tabStatus)
...
function NFCFriendPanel:_tabShake_updateFriendInfo(data)
...
function NFCFriendPanel:_tabShake_createResultUnit(data)
...
function NFCFriendPanel:_tabShake_sendAddMessage(uid, target)
	local function onSuccess(data, context)
...
function NFCFriendPanel:_tabShake_requestConfirm(uid, iptPara)
	local function onSuccess(data, context)
...
function NFCFriendPanel:_tabShake_playTipAnim()
...
function NFCFriendPanel:_tabShake_playLoadAnim()
	self.tabShake.animLeft:stopAllActions()
	self.tabShake.animRight:stopAllActions()
...
function NFCFriendPanel:initCloseButton()
...
function NFCFriendPanel:onKeyBackClicked(...)
	BasePanel.onKeyBackClicked(self)
end

function NFCFriendPanel:popout()
...
function NFCFriendPanel:popoutShowTransition()
	self.allowBackKeyTap = true
end

function NFCFriendPanel:onCloseBtnTapped()
	self.tabShake:hide()
	PopoutManager:sharedInstance():remove(self, true)
end

return NFCFriendPanel