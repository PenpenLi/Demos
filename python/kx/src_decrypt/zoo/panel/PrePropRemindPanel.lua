...
function PrePropRemindPanelModel:increaseCounter(levelId)
	print("PrePropRemindPanelModel:increaseCounter", levelId, self.levelId, self.counter)
...
function PrePropRemindPanelModel:getRemindItemId(levelId)
	print("PrePropRemindPanelModel:getRemindItemId", levelId, self:_getGameMode(levelId), self:_getMoveLimit(levelId))
