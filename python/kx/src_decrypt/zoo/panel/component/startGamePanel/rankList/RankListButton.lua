...
function RankListButton:init(uiResource, tappedCallback, ...)
	assert(uiResource)
...
function RankListButton:setString(str, ...)
...
function RankListButton:onButtonTapped(event, ...)
	...
	print("RankListButton:onButtonTapped Called !")
...
function RankListButton:create(uiResource, tappedCallback, ...)
	assert(uiResource)
	assert(tappedCallback == false or type(tappedCallback) == "function")
	assert(#{...} == 0)

	local newRankListButton = RankListButton.new()
	newRankListButton:init(uiResource, tappedCallback)
