...
function PanelPopRemoveAnim:popout(animFinishCallbck, ...)
...
function PanelPopRemoveAnim:remove(animFinishCallbck, ...)
	...
	print("PanelPopRemoveAnim:remove Called !")
	...
	local function finishCallback()
		...
		local function animFinish()
			if animFinishCallbck then
				print("lyhtest-----------PanelPopRemoveAnim:finishCallback:animFinish")
				animFinishCallbck()
			end
		end
		print("lyhtest-----------PanelPopRemoveAnim:remove")
