...
function WechatQuickPayGuide.isGuideTime() -- 满足了时间间隔条件
    ...
    print("wenkan WechatQuickPayGuide.isGuideTime, popoutTimes: "..tostring(popoutTimes).." ,lastPopoutSeconds: "..tostring(lastPopoutSeconds)..",now:"..tostring(Localhost:time() / 1000))
