...
function VerifyPhoneConfirmPanel:create(phoneLoginInfo,phoneNumber,method)
	local panel = VerifyPhoneConfirmPanel.new()
	panel:loadRequiredResource("ui/login.json")
	panel:init(phoneLoginInfo,phoneNumber,method)
	return panel
end

function VerifyPhoneConfirmPanel:init(phoneLoginInfo,phoneNumber,method)
